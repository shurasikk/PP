...
student = Student.new(name:"Ивaн", surname:"Иванов", father_name:"Иванович", other:{"id"=>23, "phone"=>"+7-928-431-41-43", "tg"=>"@Drkmo", "git"=>"@SMDPSKM"})
puts student.to_s
puts student.validate?

str="name:Иванoв, surname:Иван, father_name:Васильевич, tg:@Kjnk, git:@Rgji"
